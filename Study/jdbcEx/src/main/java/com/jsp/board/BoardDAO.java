...
public class BoardDAO {
	...
	public ArrayList<BoardDTO> boardList() {
		...
		String query = "select * from board order by bId desc"; // bId를 내림차순으로 정렬
	...
	// 검색해서 게시글 가져오는 메소드
	public ArrayList<BoardDTO> searchBoard(String searchType, String searchQuery) {
        ArrayList<BoardDTO> list = new ArrayList<BoardDTO>();
        ...
        try {
            ...
            if ("author".equals(searchType)) {
                sql = "SELECT * FROM board WHERE bName LIKE ? ORDER BY bId DESC";
            } else {
                sql = "SELECT * FROM board WHERE bTitle LIKE ? OR bContent LIKE ? ORDER BY bId DESC";
            }
